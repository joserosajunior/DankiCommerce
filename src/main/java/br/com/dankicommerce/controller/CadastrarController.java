...
public class CadastrarController {
	...
	public void salvaUsuario(@Valid Usuario usuario, String confirmaSenha) {
		...
		boolean asSeAsSenhasSaoIguais = usuario.getSenha().equals(confirmaSenha);
		validator.ensure(asSeAsSenhasSaoIguais, new SimpleMessage("erro", "A confirmação de Senha esta diferente" ));
